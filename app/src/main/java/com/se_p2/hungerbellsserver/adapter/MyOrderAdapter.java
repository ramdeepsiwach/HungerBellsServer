...
import com.se_p2.hungerbellsserver.model.CartItem;
...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Glide.with(context).load(orderModelList.get(position)
                .getCartItemList().get(0).getFoodImage()).into(holder.img_food_image);
        ...
        Common.setSpanStringColor("Number of items: ", orderModelList.get(position).getCartItemList() == null ? "0" :
                ...
                holder.txt_num_items, Color.parseColor("#46647D"));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.txt_num_items)
        TextView txt_num_items;
