...
import com.se_p2.hungerbellsserver.callback.ISingleShippingOrderCallbackListener;
import com.se_p2.hungerbellsserver.common.Common;
import com.se_p2.hungerbellsserver.model.ShippingOrderModel;
import com.se_p2.hungerbellsserver.remote.IGoogleAPI;
import com.se_p2.hungerbellsserver.remote.RetrofitGoogleClient;
...
public class TrackingOrderActivity extends FragmentActivity implements OnMapReadyCallback, ISingleShippingOrderCallbackListener, ValueEventListener {
    ...
    public void onSingleShippingOrderLoadSuccess(ShippingOrderModel shippingOrderModel) {
        ...
        LatLng orderLocation = new LatLng(shippingOrderModel.getOrderModel().getLat(),
                shippingOrderModel.getOrderModel().getLng());

        LatLng shipperLocation = new LatLng(shippingOrderModel.getCurrentLat(),
        ...
        if (shipperMarker == null) {
            int height, width;
            height = width = 80;
            BitmapDrawable bitmapDrawable = (BitmapDrawable) ContextCompat.getDrawable(TrackingOrderActivity.this,
