...
import com.se_p2.hungerbellsserver.adapter.MyShipperAdapter;
import com.se_p2.hungerbellsserver.common.Common;
import com.se_p2.hungerbellsserver.eventBus.ChangeMenuClick;
import com.se_p2.hungerbellsserver.eventBus.UpdateShipperEvent;
...
public class ShipperFragment extends Fragment {
    ...
    public void onUpdateShipperActive(UpdateShipperEvent event){
        ...
        updateData.put("active",event.getActive());
        FirebaseDatabase.getInstance()
                .getReference(Common.SHIPPER_REF)
                .child(event.getShipperModel().getKey())
                .updateChildren(updateData)
                .addOnFailureListener(e -> Toast.makeText(getContext(), ""+e.getMessage(), Toast.LENGTH_SHORT).show())
                .addOnSuccessListener(aVoid -> Toast.makeText(getContext(), "Update state to "+event.getActive(), Toast.LENGTH_SHORT).show());
    }
}